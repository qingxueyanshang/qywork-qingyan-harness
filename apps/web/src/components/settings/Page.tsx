 ...
 *
 * **为什么集中在一处。** 记忆 / 技能 / MCP / 插件 / Agent Team 五页说的是同一件事的五个实例——
 * 「这一层装了哪些条目，怎么加一个」。各页自己拼版面的话，同一个「暂无内容」
 * 会长出五种高度、五种底色，而它们本来该是同一块。
 *
 * **页头钉在滚动区顶上，且整块一起钉。** 标题、说明、右上角动作是同一块。只钉标题的话，滚过之后它和
 * 动作按钮会错开一整段。
 */
 ...
 *
 * **动作归分区，不归页头。** 一页里可能有好几段各自能新增（角色 / 后端、
